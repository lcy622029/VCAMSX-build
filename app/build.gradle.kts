...
// Xposed API for advanced customization and hooking into Android apps (compile only)
    ...
    implementation("tv.danmaku.ijk.media:ijkplayer-java:0.10.1")
    implementation("tv.danmaku.ijk.media:ijkplayer-armv7a:0.10.1")
    implementation("tv.danmaku.ijk.media:ijkplayer-arm64:0.10.1")
}
